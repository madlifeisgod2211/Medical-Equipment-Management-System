...
export default function CustomPaginationActionsTable() {
  const {
    userDeviceState: { userDevicesList, userDeviceLoading },
    getUserDevicesList,
  ...
  const emptyRows =
    page > 0
      ? Math.max(0, (1 + page) * rowsPerPage - userDevicesList.length)
      : 0;
